...
def attack(char_name: str, char_class: str) -> str:
    """Get name and class of your char, then attack the anemy.
    with print action.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Get name and class of your char.
    then show deffender pounts in console.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Get name and class of your char.
    then activate special spell with print result.
    """
    if char_class == 'warrior':
        return (
...
def choice_char_class() -> str:
    """Welcom page. Tell about char class and ask your char name."""
    approve_choice: str = ''
    char_class: str = ''
